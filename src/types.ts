...
export const InstructionIdSchema = z.templateLiteral([
  "insn_",
  z.number().int(),
]);
...
export const ProtoDancerIdSchema = z.templateLiteral([
...
export function parseDancerId(id: DancerId): {
  ...
  return {
    proto: ProtoDancerIdSchema.parse(id.slice(0, i) + "_0"),
    offset: parseInt(id.slice(i + 1)),
  };
}
...
export function dancerPosition(
  id: DancerId,
...
export const AtomicInstructionSchema = z
...
export const DancerHandsSchema = z
  .object({
...
const ProtoDancerRecord = <T extends z.ZodType>(v: T) =>
  z.object({
    up_lark_0: v,
    up_robin_0: v,
    down_lark_0: v,
