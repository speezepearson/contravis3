...
export const RollawaySchema = z.enum(['lark_rtl', 'lark_ltr', 'robin_rtl', 'robin_ltr']);
export type Rollaway = z.infer<typeof RollawaySchema>;
...
export const AtomicInstructionSchema = z.discriminatedUnion('type', [
  ...
  z.object({ ...baseFields, type: z.literal('long_lines'), rollaway: RollawaySchema.optional() }),
]);
