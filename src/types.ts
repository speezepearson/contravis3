...
export const AtomicInstructionSchema = z.discriminatedUnion('type', [
  ...
  z.object({ ...baseFields, type: z.literal('robins_chain') }),
...
export const ActionTypeSchema = z.enum(['take_hands', 'drop_hands', 'allemande', 'do_si_do', 'circle', 'pull_by', 'turn', 'step', 'balance', 'swing', 'box_the_gnat', 'give_and_take_into_swing', 'robins_chain', 'mad_robin']);
