...
export const AtomicInstructionSchema = z.discriminatedUnion('type', [
  ...
  z.object({ ...baseFields, type: z.literal('step'), direction: OffsetRelativeDirectionSchema, distance: z.number(), facing: OffsetRelativeDirectionSchema }),
  z.object({ ...baseFields, type: z.literal('balance'), direction: OffsetRelativeDirectionSchema, distance: z.number() }),
  z.object({ ...baseFields, type: z.literal('swing'), relationship: FoilRelationshipSchema, endFacing: OffsetRelativeDirectionSchema }),
  z.object({ ...baseFields, type: z.literal('box_the_gnat'), relationship: FoilRelationshipSchema }),
  z.object({ ...baseFields, type: z.literal('give_and_take_into_swing'), relationship: FoilRelationshipSchema, role: RoleSchema, endFacing: OffsetRelativeDirectionSchema }),
...
export const ActionTypeSchema = z.enum(['take_hands', 'drop_hands', 'allemande', 'do_si_do', 'circle', 'pull_by', 'step', 'balance', 'swing', 'box_the_gnat', 'give_and_take_into_swing', 'mad_robin', 'short_waves', 'long_waves', 'long_lines']);
