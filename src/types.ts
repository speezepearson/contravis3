...
export const AtomicInstructionSchema = z.discriminatedUnion('type', [
  ...
  z.object({ ...baseFields, type: z.literal('pass_by'), relationship: RelationshipSchema, hand: HandSchema }),
  ...
  z.object({ ...baseFields, type: z.literal('balance'), relationship: RelationshipSchema, }),
