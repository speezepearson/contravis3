...
const EMPTY_HANDS: Record<ProtoDancerId, DancerHands> = {
  up_lark_0: {},
  up_robin_0: {},
  down_lark_0: {},
  down_robin_0: {},
...
describe("generateAllKeyframes", () => {
  ...
  describe("take_hands", () => {
    it("adds hand connections for neighbor pairs", () => {
      const instructions: Instruction[] = z
      ...
      const instructions: Instruction[] = z.array(InstructionSchema).parse([
        {
          ...
          type: "turn",
          offset: 0,
          target: { kind: "direction", value: "across" },
        },
        {
          id: "insn_2",
          beats: 0,
      ...
      const instructions: Instruction[] = z.array(InstructionSchema).parse([
        {
          ...
          type: "turn",
          offset: 0,
          target: { kind: "direction", value: "up" },
        },
        {
          id: "insn_2",
          beats: 0,
        ...
        .parse([
          {
            ...
            type: "turn",
            offset: 0,
            target: { kind: "direction", value: "down" },
          },
        ]);
      const kfs = generateAllKeyframes(instructions).keyframes;
      const last = kfs[kfs.length - 1];
        ...
        .parse([
          {
            ...
            type: "turn",
            offset: 0,
            target: { kind: "direction", value: "out" },
          },
        ]);
      const kfs = generateAllKeyframes(instructions).keyframes;
      const last = kfs[kfs.length - 1];
        ...
        .parse([
          {
            ...
            type: "turn",
            offset: 0,
            target: { kind: "direction", value: "progression" },
          },
        ]);
      const kfs = generateAllKeyframes(instructions).keyframes;
      const last = kfs[kfs.length - 1];
        ...
        .parse([
          {
            ...
            type: "turn",
            offset: 0,
            target: { kind: "direction", value: "forward" },
          },
        ]);
      const kfs = generateAllKeyframes(instructions).keyframes;
      const last = kfs[kfs.length - 1];
        ...
        .parse([
          {
            ...
            type: "turn",
            offset: 0,
            target: { kind: "direction", value: "back" },
          },
        ]);
      const kfs = generateAllKeyframes(instructions).keyframes;
      const last = kfs[kfs.length - 1];
        ...
        .parse([
          {
            ...
            type: "turn",
            offset: 0,
            target: { kind: "direction", value: "right" },
          },
        ]);
      const kfs = generateAllKeyframes(instructions).keyframes;
      const last = kfs[kfs.length - 1];
        ...
        .parse([
          {
            ...
            type: "turn",
            offset: 0,
            target: { kind: "direction", value: "left" },
          },
        ]);
      const kfs = generateAllKeyframes(instructions).keyframes;
      const last = kfs[kfs.length - 1];
        ...
        .parse([
          {
            ...
            type: "turn",
            offset: 0,
            target: { kind: "relationship", value: "partner" },
          },
        ]);
      const kfs = generateAllKeyframes(instructions).keyframes;
      const last = kfs[kfs.length - 1];
  ...
  describe("allemande", () => {
    ...
    it("dancers return to approximately their starting positions after 1 full rotation", () => {
      ...
      const last = kfs[kfs.length - 1];
      expect(last.dancers["up_lark_0"].x).toBeCloseTo(
        init.dancers["up_lark_0"].x,
        1,
      );
      expect(last.dancers["up_lark_0"].y).toBeCloseTo(
        init.dancers["up_lark_0"].y,
        1,
      );
    });
    ...
    it("allemande right: right shoulder faces partner (facing is 90° CCW from direction to partner)", () => {
      ...
      const dirToPartner =
        (Math.atan2(dr.x - ul.x, dr.y - ul.y) * 180) / Math.PI;
  ...
  describe("step", () => {
        ...
        .parse([
          {
            ...
            beats: 4,
            type: "step",
            direction: { kind: "direction", value: "up" },
            distance: 1,
          },
        ]);
      const kfs = generateAllKeyframes(instructions).keyframes;
        ...
        .parse([
          {
            ...
            beats: 4,
            type: "step",
            direction: { kind: "direction", value: "down" },
            distance: 0.5,
          },
        ]);
      const kfs = generateAllKeyframes(instructions).keyframes;
    ...
    it("moves dancers across (toward center of set)", () => {
        ...
        .parse([
          {
            ...
            beats: 4,
            type: "step",
            direction: { kind: "direction", value: "across" },
            distance: 0.5,
          },
        ]);
      const kfs = generateAllKeyframes(instructions).keyframes;
      ...
      const last = kfs[kfs.length - 1];
      expect(last.dancers["up_lark_0"].x).toBeCloseTo(
        init.dancers["up_lark_0"].x + 0.5,
        5,
      );
      expect(last.dancers["up_robin_0"].x).toBeCloseTo(
        init.dancers["up_robin_0"].x - 0.5,
        5,
      );
    });
        ...
        .parse([
          {
            ...
            beats: 4,
            type: "step",
            direction: { kind: "direction", value: "out" },
            distance: 0.5,
          },
        ]);
      const kfs = generateAllKeyframes(instructions).keyframes;
        ...
        .parse([
          {
            ...
            beats: 4,
            type: "step",
            direction: { kind: "relationship", value: "partner" },
            distance: 0.5,
          },
        ]);
      const kfs = generateAllKeyframes(instructions).keyframes;
    ...
    it("moves dancers in their progression direction", () => {
        ...
        .parse([
          {
            ...
            beats: 4,
            type: "step",
            direction: { kind: "direction", value: "progression" },
            distance: 1,
          },
        ]);
      const kfs = generateAllKeyframes(instructions).keyframes;
      ...
      const last = kfs[kfs.length - 1];
      expect(last.dancers["up_lark_0"].y).toBeCloseTo(
        init.dancers["up_lark_0"].y + 1,
        5,
      );
      expect(last.dancers["up_robin_0"].y).toBeCloseTo(
        init.dancers["up_robin_0"].y + 1,
        5,
      );
      expect(last.dancers["down_lark_0"].y).toBeCloseTo(
        init.dancers["down_lark_0"].y - 1,
        5,
      );
      expect(last.dancers["down_robin_0"].y).toBeCloseTo(
        init.dancers["down_robin_0"].y - 1,
        5,
      );
    });
    ...
    it("moves dancers right (90° CW from facing)", () => {
        ...
        .parse([
          {
            ...
            beats: 4,
            type: "step",
            direction: { kind: "direction", value: "right" },
            distance: 1,
          },
        ]);
      const kfs = generateAllKeyframes(instructions).keyframes;
      ...
      expect(last.dancers["up_lark_0"].x).toBeCloseTo(
        init.dancers["up_lark_0"].x + 1,
        5,
      );
      expect(last.dancers["down_lark_0"].x).toBeCloseTo(
        init.dancers["down_lark_0"].x - 1,
        5,
      );
    });
  ...
  describe("split", () => {
    ...
    it("empty listB: group B dancers hold still", () => {
      ...
      // Downs unchanged
      expect(last.dancers["down_lark_0"]).toEqual(init.dancers["down_lark_0"]);
      expect(last.dancers["down_robin_0"]).toEqual(
        init.dancers["down_robin_0"],
      );
    });
  ...
  describe("balance", () => {
    ...
    it("dancers are displaced at the midpoint of a balance", () => {
      ...
      expect(mid.dancers["up_lark_0"].y).toBeCloseTo(
        init.dancers["up_lark_0"].y + 0.2,
        1,
      );
    });
  ...
  describe("do_si_do", () => {
    ...
    it("dancers maintain their original facing throughout", () => {
      ...
      const mid = kfs[Math.floor(kfs.length / 2)];
      expect(mid.dancers["up_lark_0"].facing).toBeCloseTo(
        init.dancers["up_lark_0"].facing,
        1,
      );
      expect(mid.dancers["down_robin_0"].facing).toBeCloseTo(
        init.dancers["down_robin_0"].facing,
        1,
      );
    });
  ...
  describe("circle", () => {
    ...
    it("dancers face center throughout", () => {
      ...
      for (const id of [
        ...
        const angleToCenter =
          ((((Math.atan2(-d.x, -d.y) * 180) / Math.PI) % 360) + 360) % 360;
  ...
  describe("pull_by", () => {
    it("dancers swap positions at the end", () => {
      ...
      expect(last.dancers["up_lark_0"].x).toBeCloseTo(
        init.dancers["down_robin_0"].x,
        5,
      );
      expect(last.dancers["up_lark_0"].y).toBeCloseTo(
        init.dancers["down_robin_0"].y,
        5,
      );
      expect(last.dancers["down_robin_0"].x).toBeCloseTo(
        init.dancers["up_lark_0"].x,
        5,
      );
      expect(last.dancers["down_robin_0"].y).toBeCloseTo(
    ...
    it("pull_by left displaces laterally in the opposite direction", () => {
      const rightInstructions: Instruction[] = z
        .array(InstructionSchema)
        .parse([
          {
            id: "insn_1",
      ...
      const leftInstructions: Instruction[] = z
        .array(InstructionSchema)
        .parse([
          {
            id: "insn_1",
      ...
      expect(rightMid.dancers["up_lark_0"].x).toBeCloseTo(
        -leftMid.dancers["up_lark_0"].x - 1,
        1,
      );
    });
  });
    ...
    it("warns when dancers step apart while holding hands", () => {
      const instructions: Instruction[] = z.array(InstructionSchema).parse([
        ...
        },
        {
          ...
          beats: 2,
          type: "step",
          direction: { kind: "direction", value: "back" },
          distance: 0.4,
        },
      ]);
      const keyframes = generateAllKeyframes(instructions).keyframes;
