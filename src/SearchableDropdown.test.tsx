...
describe("SearchableDropdown", () => {
  it("renders an input field", () => {
    render(
      <SearchableDropdown options={OPTIONS} value="" onChange={() => {}} />,
    );
  ...
  it("typing reopens the popover after a selection", async () => {
    ...
    rerender(
      <SearchableDropdown options={OPTIONS} value="b" onChange={onChange} />,
    );
  ...
  it("does not call onChange with values outside the options on blur", async () => {
    ...
    rerender(
      <SearchableDropdown options={OPTIONS} value="xyz" onChange={onChange} />,
    );
    onChange.mockClear();
  ...
  it("resets highlight to first item when filter changes", async () => {
    ...
    rerender(
      <SearchableDropdown options={OPTIONS} value="ch" onChange={onChange} />,
    );
    const items = screen.getAllByRole("option");
    expect(items).toHaveLength(1);
