...
function makeKeyframe(beat: number, positions: {
  ...
  return {
    beat,
    dancers: {
      up_lark_0:    { x: positions.up_lark_0[0],    y: positions.up_lark_0[1],    facing: positions.up_lark_0[2] },
      up_robin_0:   { x: positions.up_robin_0[0],   y: positions.up_robin_0[1],   facing: positions.up_robin_0[2] },
      down_lark_0:  { x: positions.down_lark_0[0],  y: positions.down_lark_0[1],  facing: positions.down_lark_0[2] },
      down_robin_0: { x: positions.down_robin_0[0], y: positions.down_robin_0[1], facing: positions.down_robin_0[2] },
    },
